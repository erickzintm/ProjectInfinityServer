ServerEvents.recipes((event) => {
  ...
  event
    ...
    .id('compactmekanismmachines:compact_fission_reactor1');
});
...
ServerEvents.recipes((event) => {
  ...
  event
    .custom({
      ...
      key: {
        ...
        K: {
          ...
          count: 1,
          nbt: '{tank_level:"basic", chemical_id:"evolvedmekanism:plaslitherite"}'
        },
        L: {
          item: 'evolvedmekanism:dense_control_circuit',
        },
        M: {
          ...
          item: 'kubejs:chemical_tank_token',
          count: 1,
          nbt: '{tank_level:"basic", chemical_id:"mekanism_extras:molten_thermonuclear"}'
        },
        N: {
          item: 'mekanism_extras:alloy_spectrum',
        },
        ...
        S: {
          ...
          item: 'kubejs:chemical_tank_token',
          count: 1,
          nbt: '{tank_level:"basic", chemical_id:"mekanism_extras:naquadah_hexafluoride"}'
        },
        T: {
          type: 'forge:partial_nbt',
          item: 'kubejs:chemical_tank_token',
          count: 1,
          nbt: '{tank_level:"basic", chemical_id:"evolvedmekanism:better_gold"}'
        },
        U: {
          item: 'mekanismgenerators:control_rod_assembly',
        },
    ...
    .id('compactmekanismmachines:compact_fission_reactor2');
});